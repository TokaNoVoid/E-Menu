...
<div id="TopNav" class="relative flex flex-col px-5 mt-[20px] h-[170px]">
    <div class="relative flex items-center justify-between">
        <div class="flex flex-col gap-1">
            ...
            <h1 class="text-white font-semibold"><?php echo e($store->name); ?></h1>
        </div>
        <a href="#"
            ...
            <a href="<?php echo e(route('product.find.results', $store->username)  . '?category=' . $category->slug); ?>"
                ...
                <div class="flex flex-col items-center shrink-0 gap-2 text-center">
                    <div
                        ...
                        <img src="<?php echo e(asset('storage/'. $category->icon   )); ?>" class="w-full h-full object-contain"
                            alt="thumbnail">
                    </div>
                    <div class="flex flex-col gap-[2px]">
                        <h3 class="font-light text-[#504D53] text-[14px]"><?php echo e($category->name); ?></h3>
                    </div>
                </div>
            </a>
