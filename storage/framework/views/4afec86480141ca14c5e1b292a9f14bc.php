...
<div id="Cart" class="flex flex-col gap-4 mt-[10px] px-5 transition-all duration-500">
    ...
    <div class="cart-item flex gap-4 flex-col rounded-[8px] border border-[#F1F2F6] p-[12px]  bg-white hover:bg-[#FFF7F0] hover:border-[1px] hover:border-[#F3AF00] transition-all duration-500"
        data-id="<?php echo e($product->id); ?>">
        <div class="flex gap-4">
            <div class="w-[128px] h-[88px]">
                <img src="<?php echo e(asset('storage/' .$product->image)); ?>" class="w-full object-cover rounded-[8px]" alt="icon">
            </div>
            <div class="flex flex-col gap-1 w-full">
                <div class="flex items-center justify-between">
                    ...
                    <a href="#" class="text-[#FF001A] font-[400] text-[12px] ml-2" onclick="deleteItem(this)">
                        Delete
                    </a>
                </div>
                ...
                <div class="flex items-center justify-between ">
                    <p class="text-[#FF001A] font-[600] text-[14px]" data-id="<?php echo e($product->id); ?>" id="price">
                    ...
                    <div class="flex items-center gap-2 ">
                        <button type="button"
                            ...
                            data-id="<?php echo e($product->id); ?>" onclick="decreaseQuantity(this.dataset.id)">
                            <img src="<?php echo e(asset('assets/images/icons/ic_minus.svg')); ?>" class="w-full h-full" alt="icon">
                        </button>

                        <p class="text-[#FF001A] font-[600] text-[14px]" data-id="<?php echo e($product->id); ?>" id="qty">
                            1
                        </p>

                        <button type="button"
                            class="flex items-center justify-center w-[24px] h-[24px] rounded-full bg-transparent"
                            data-id="<?php echo e($product->id); ?>" onclick="increaseQuantity(this.dataset.id)">
        ...
        <label
            ...
            <img src="<?php echo e(asset('assets/images/icons/Edit.svg')); ?>" class="w-5 h-5 flex shrink-0" alt="icon">
            <input type="text" name="notes" id="notes" data-id="<?php echo e($product->id); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /usr/www/E-Menu/resources/views/Pages/cart.blade.php ENDPATH**/ ?>